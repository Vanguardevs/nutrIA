...
export default function Settings() {
  ...
  const ConfigItem = ({ icon, title, subtitle, onPress, showArrow = true }: any) => (
    <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 18, fontWeight: "600", marginBottom: 12, marginLeft: 4 },
  sectionContainer: {
    borderRadius: 16,
    overflow: "hidden",
    shadowColor: "#000",
  ...
  configItemLeft: { flexDirection: "row", alignItems: "center", flex: 1 },
  iconContainer: {
    width: 44,
    height: 44,
    borderRadius: 12,
  ...
  configItemText: { flex: 1 },
  configItemTitle: { fontSize: 16, fontWeight: "600", marginBottom: 2 },
  configItemSubtitle: { fontSize: 14, fontWeight: "400", lineHeight: 18 },
  separator: { height: 1, marginLeft: 80 },
  logoutSection: { marginTop: 40, paddingHorizontal: 24 },
