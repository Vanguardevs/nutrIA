...
async function createUser(){
    ...
    //Os parâmetros após a rota leva as variaveis dos campos de cadastro para próxima página 
    navegacao.navigate('HealthRegister', {nome, email, password, idade, sexo}); 
    }catch(error){
    ...
    return(
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.bottomContainer}>
                <CustomButton title="Próximo" onPress={createUser}/>
            </View>
